...
const ChooseBattlefieldActionSchema = z.object({
...
const ActivateAbilityActionSchema = z.object({
...
const PassPriorityActionSchema = z.object({
  type: z.literal("PassPriority"),
  playerId: PlayerIdSchema,
});
const PassFocusActionSchema = z.object({ type: z.literal("PassFocus"), playerId: PlayerIdSchema });
const AssignDamageActionSchema = z.object({
  type: z.literal("AssignDamage"),
  playerId: PlayerIdSchema,
  assignments: z.array(DamageAssignmentSchema),
});
const ChooseTargetsActionSchema = z.object({
  type: z.literal("ChooseTargets"),
  playerId: PlayerIdSchema,
  decisionId: DecisionIdSchema,
  targets: z.array(CardIdSchema),
});
const ChooseYesNoActionSchema = z.object({
  type: z.literal("ChooseYesNo"),
  playerId: PlayerIdSchema,
  decisionId: DecisionIdSchema,
  choice: z.boolean(),
});
const ChooseOneActionSchema = z.object({
