...
export const ActionNodeSchema = z.discriminatedUnion('type', [
  z.object({ type: z.literal('Deal'), targets: SelectorNodeSchema, amount: NumberExprSchema, bonus: NumberExprSchema.optional() }),
  ...
  z.object({ type: z.literal('CreateToken'), defId: CardDefIdSchema, zone: ZoneRefSchema, count: NumberExprSchema }),
  z.object({ type: z.literal('Counter'), targets: SelectorNodeSchema }),
  z.object({ type: z.literal('AddResource'), player: PlayerRefSchema, energy: NumberExprSchema, power: NumberExprSchema }),
